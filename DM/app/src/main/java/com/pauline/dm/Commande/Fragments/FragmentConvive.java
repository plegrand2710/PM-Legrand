...
public class FragmentConvive extends Fragments {
    ...
    public static FragmentConvive newInstance(ConviveCommande conviveCommande) {
        FragmentConvive fragment = new FragmentConvive();
        Bundle args = new Bundle();
        args.putSerializable("conviveCommande", conviveCommande);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            conviveCommande = (ConviveCommande) getArguments().getSerializable("conviveCommande");
        }
